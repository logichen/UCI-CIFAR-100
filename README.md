...
We also test on a smaller model named EfficientNet-exx with the refined labels of EfficientNet-B0, which is slightly smaller than model EfficientNet-ex. We did several trainings on it and sometimes the best test accuracy was above 80%.
